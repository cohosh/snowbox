...
RUN echo "deb https://deb.nodesource.com/node_12.x bookworm main\ndeb-src https://deb.nodesource.com/node_12.x bookworm main" | tee /etc/apt/sources.list.d/nodesource.list
RUN echo "deb [signed-by=/usr/share/keyrings/tor-archive-keyring.gpg] https://deb.torproject.org/torproject.org bookworm main\ndeb-src [signed-by=/usr/share/keyrings/tor-archive-keyring.gpg] https://deb.torproject.org/torproject.org bookworm main" | tee /etc/apt/sources.list.d/tor.list
